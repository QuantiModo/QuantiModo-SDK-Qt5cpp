...
SWGInline_response_200::init() {
    success = false;
data = new QList<SWGTrackingReminderNotification*>();
}
...
if(data != NULL) {
        QList<SWGTrackingReminderNotification*>* arr = data;
        foreach(SWGTrackingReminderNotification* o, *arr) {
            delete o;
        }
        delete data;
    }
...
setValue(&data, pJson["data"], "QList", "SWGTrackingReminderNotification");
}
...
SWGInline_response_200::asJsonObject() {
    ...
    QList<SWGTrackingReminderNotification*>* dataList = data;
    QJsonArray dataJsonArray;
    toJsonArray((QList<void*>*)data, &dataJsonArray, "data", "SWGTrackingReminderNotification");
...
QList<SWGTrackingReminderNotification*>*
SWGInline_response_200::getData() {
    return data;
}
void
SWGInline_response_200::setData(QList<SWGTrackingReminderNotification*>* data) {
    this->data = data;
}
