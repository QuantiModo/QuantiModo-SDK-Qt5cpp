...
void
SWGVariablesApi::v1PublicVariablesSearchSearchGet(QString* search, QString* accessToken, QString* categoryName, QString* source, QString* effectOrCause, QString* publicEffectOrCause, qint32 limit, qint32 offset, qint32 sort) {
    QString fullPath;
    ...
    if (fullPath.indexOf("?") > 0) 
      ...
      fullPath.append("?");
    fullPath.append(QUrl::toPercentEncoding("publicEffectOrCause"))
        .append("=")
        .append(QUrl::toPercentEncoding(stringValue(publicEffectOrCause)));
...
void
SWGVariablesApi::v1UserVariablesPost(SWGUserVariables userVariables) {
    QString fullPath;
    ...
    QString output = userVariables.asJson();
...
void
SWGVariablesApi::v1VariablesGet(QString* accessToken, qint32 id, qint32 userId, QString* category, QString* name, QString* lastUpdated, QString* source, QString* latestMeasurementTime, QString* numberOfMeasurements, QString* lastSource, qint32 limit, qint32 offset, qint32 sort) {
    QString fullPath;
...
void
SWGVariablesApi::v1VariablesPost(SWGVariablesNew body, QString* accessToken) {
    QString fullPath;
    fullPath.append(this->host).append(this->basePath).append("/v1/variables");
...
void
SWGVariablesApi::v1VariablesSearchSearchGet(QString* search, QString* accessToken, QString* categoryName, bool includePublic, bool manualTracking, QString* source, QString* effectOrCause, QString* publicEffectOrCause, qint32 limit, qint32 offset) {
    QString fullPath;
    ...
    if (fullPath.indexOf("?") > 0) 
      ...
      fullPath.append("?");
    fullPath.append(QUrl::toPercentEncoding("manualTracking"))
        .append("=")
        .append(QUrl::toPercentEncoding(stringValue(manualTracking)));
...
void
SWGVariablesApi::v1VariablesVariableNameGet(QString* variableName, QString* accessToken) {
    QString fullPath;
