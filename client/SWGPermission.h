...
qint32 getMinTimestamp();
    void setMinTimestamp(qint32 minTimestamp);
qint32 getMaxTimestamp();
    void setMaxTimestamp(qint32 maxTimestamp);
qint32 getMinTimeOfDay();
    void setMinTimeOfDay(qint32 minTimeOfDay);
qint32 getMaxTimeOfDay();
    void setMaxTimeOfDay(qint32 maxTimeOfDay);
QString* getWeek();
