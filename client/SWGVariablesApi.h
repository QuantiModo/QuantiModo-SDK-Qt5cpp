...
public:
    ...
    void v1PublicVariablesSearchSearchGet(QString* search, QString* accessToken, QString* categoryName, QString* source, QString* effectOrCause, QString* publicEffectOrCause, qint32 limit, qint32 offset, qint32 sort);
    void v1UserVariablesPost(SWGUserVariables userVariables);
    void v1VariableCategoriesGet();
    void v1VariablesGet(QString* accessToken, qint32 id, qint32 userId, QString* category, QString* name, QString* lastUpdated, QString* source, QString* latestMeasurementTime, QString* numberOfMeasurements, QString* lastSource, qint32 limit, qint32 offset, qint32 sort);
    void v1VariablesPost(SWGVariablesNew body, QString* accessToken);
    void v1VariablesSearchSearchGet(QString* search, QString* accessToken, QString* categoryName, bool includePublic, bool manualTracking, QString* source, QString* effectOrCause, QString* publicEffectOrCause, qint32 limit, qint32 offset);
    void v1VariablesVariableNameGet(QString* variableName, QString* accessToken);
