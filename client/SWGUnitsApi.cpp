...
void
SWGUnitsApi::v1UnitsGet(QString* accessToken, qint32 id, QString* unitName, QString* abbreviatedUnitName, QString* categoryName) {
    QString fullPath;
...
void
SWGUnitsApi::v1UnitsVariableGet(QString* accessToken, QString* unitName, QString* abbreviatedUnitName, QString* categoryName, QString* variable) {
    QString fullPath;
