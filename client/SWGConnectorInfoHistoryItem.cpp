...
setValue(&createdAt, pJson["createdAt"], "QString", "QString");
}
...
obj->insert("success", QJsonValue(success));
    ...
    toJsonValue(QString("createdAt"), createdAt, obj, QString("QString"));
...
void
SWGConnectorInfoHistoryItem::setNumberOfMeasurements(qint32 numberOfMeasurements) {
...
void
SWGConnectorInfoHistoryItem::setCreatedAt(QString* createdAt) {
