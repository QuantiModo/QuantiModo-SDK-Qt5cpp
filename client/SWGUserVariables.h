...
QString* getExperimentStartTime();
    void setExperimentStartTime(QString* experimentStartTime);
QString* getExperimentEndTime();
    void setExperimentEndTime(QString* experimentEndTime);
...
qint32 onsetDelay;
QString* experimentStartTime;
QString* experimentEndTime;
};
