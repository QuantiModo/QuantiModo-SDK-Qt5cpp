...
public:
    ...
    void v1AggregatedCorrelationsGet(QString* accessToken, QString* effect, QString* cause, QString* correlationCoefficient, QString* onsetDelay, QString* durationOfAction, QString* lastUpdated, qint32 limit, qint32 offset, qint32 sort);
    void v1AggregatedCorrelationsPost(SWGPostCorrelation body, QString* accessToken);
    void v1CorrelationsGet(QString* accessToken, QString* effect, QString* cause, QString* correlationCoefficient, QString* onsetDelay, QString* durationOfAction, QString* lastUpdated, qint32 limit, qint32 offset, qint32 sort);
    void v1OrganizationsOrganizationIdUsersUserIdVariablesVariableNameCausesGet(qint32 organizationId, qint32 userId, QString* variableName, QString* organizationToken, QString* accessToken, QString* includePublic);
    void v1OrganizationsOrganizationIdUsersUserIdVariablesVariableNameEffectsGet(qint32 organizationId, qint32 userId, QString* variableName, QString* organizationToken, QString* accessToken, QString* includePublic);
    void v1PublicCorrelationsSearchSearchGet(QString* search, QString* effectOrCause, QString* accessToken);
    void v1VariablesVariableNameCausesGet(QString* variableName);
    void v1VariablesVariableNameEffectsGet(QString* variableName, QString* accessToken);
    void v1VariablesVariableNamePublicCausesGet(QString* variableName, QString* accessToken);
    void v1VariablesVariableNamePublicEffectsGet(QString* variableName, QString* accessToken);
    void v1VotesDeletePost(SWGVoteDelete body, QString* accessToken);
    void v1VotesPost(SWGPostVote body, QString* accessToken);
    
private:
    void v1AggregatedCorrelationsGetCallback (HttpRequestWorker * worker);
    void v1AggregatedCorrelationsPostCallback (HttpRequestWorker * worker);
...
signals:
    void v1AggregatedCorrelationsGetSignal(QList<SWGCorrelation*>* summary);
    void v1AggregatedCorrelationsPostSignal();
