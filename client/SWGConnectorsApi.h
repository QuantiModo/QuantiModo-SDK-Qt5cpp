...
public:
    ...
    void v1ConnectJsGet(QString* accessToken);
    void v1ConnectMobileGet(QString* accessToken);
    void v1ConnectorsConnectorConnectGet(QString* connector, QString* accessToken);
    void v1ConnectorsConnectorConnectInstructionsGet(QString* connector, QString* parameters, QString* url, bool usePopup, QString* accessToken);
    void v1ConnectorsConnectorConnectParameterGet(QString* connector, QString* displayName, QString* key, QString* placeholder, QString* type, bool usePopup, QString* accessToken, QString* defaultValue);
    void v1ConnectorsConnectorDisconnectGet(QString* connector);
    void v1ConnectorsConnectorInfoGet(QString* connector, QString* accessToken);
    void v1ConnectorsConnectorUpdateGet(QString* connector, QString* accessToken);
    void v1ConnectorsListGet();
    
private:
    void v1ConnectJsGetCallback (HttpRequestWorker * worker);
