...
void
SWGCorrelationsApi::v1AggregatedCorrelationsGet(QString* accessToken, QString* effect, QString* cause, QString* correlationCoefficient, QString* onsetDelay, QString* durationOfAction, QString* lastUpdated, qint32 limit, qint32 offset, qint32 sort) {
    QString fullPath;
    fullPath.append(this->host).append(this->basePath).append("/v1/aggregatedCorrelations");
    ...
    connect(worker,
            ...
            this,
            &SWGCorrelationsApi::v1AggregatedCorrelationsGetCallback);

    worker->execute(&input);
}

void
SWGCorrelationsApi::v1AggregatedCorrelationsGetCallback(HttpRequestWorker * worker) {
    QString msg;
    ...
    emit v1AggregatedCorrelationsGetSignal(output);
    
}
void
SWGCorrelationsApi::v1AggregatedCorrelationsPost(SWGPostCorrelation body, QString* accessToken) {
    QString fullPath;
    fullPath.append(this->host).append(this->basePath).append("/v1/aggregatedCorrelations");
    ...
    connect(worker,
            &HttpRequestWorker::on_execution_finished,
            this,
            &SWGCorrelationsApi::v1AggregatedCorrelationsPostCallback);

    worker->execute(&input);
}

void
SWGCorrelationsApi::v1AggregatedCorrelationsPostCallback(HttpRequestWorker * worker) {
    QString msg;
    if (worker->error_type == QNetworkReply::NoError) {
        msg = QString("Success! %1 bytes").arg(worker->response.length());
    }
    ...
    emit v1AggregatedCorrelationsPostSignal();
}
void
SWGCorrelationsApi::v1CorrelationsGet(QString* accessToken, QString* effect, QString* cause, QString* correlationCoefficient, QString* onsetDelay, QString* durationOfAction, QString* lastUpdated, qint32 limit, qint32 offset, qint32 sort) {
    QString fullPath;
...
void
SWGCorrelationsApi::v1OrganizationsOrganizationIdUsersUserIdVariablesVariableNameCausesGet(qint32 organizationId, qint32 userId, QString* variableName, QString* organizationToken, QString* accessToken, QString* includePublic) {
    QString fullPath;
...
void
SWGCorrelationsApi::v1OrganizationsOrganizationIdUsersUserIdVariablesVariableNameEffectsGet(qint32 organizationId, qint32 userId, QString* variableName, QString* organizationToken, QString* accessToken, QString* includePublic) {
    QString fullPath;
...
void
SWGCorrelationsApi::v1PublicCorrelationsSearchSearchGet(QString* search, QString* effectOrCause, QString* accessToken) {
    QString fullPath;
...
void
SWGCorrelationsApi::v1VariablesVariableNameEffectsGet(QString* variableName, QString* accessToken) {
    QString fullPath;
...
void
SWGCorrelationsApi::v1VariablesVariableNamePublicCausesGet(QString* variableName, QString* accessToken) {
    QString fullPath;
...
void
SWGCorrelationsApi::v1VariablesVariableNamePublicEffectsGet(QString* variableName, QString* accessToken) {
    QString fullPath;
...
void
SWGCorrelationsApi::v1VotesDeletePost(SWGVoteDelete body, QString* accessToken) {
    QString fullPath;
...
void
SWGCorrelationsApi::v1VotesPost(SWGPostVote body, QString* accessToken) {
    QString fullPath;
