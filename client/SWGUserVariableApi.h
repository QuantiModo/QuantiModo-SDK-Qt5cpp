...
signals:
    void userVariablesGetSignal(SWGInline_response_200_9* summary);
    void userVariablesPostSignal(SWGInline_response_200_30* summary);
    void userVariablesIdGetSignal(SWGInline_response_200_30* summary);
