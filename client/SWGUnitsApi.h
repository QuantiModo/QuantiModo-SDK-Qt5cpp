...
public:
    ...
    void v1UnitsGet(QString* accessToken, qint32 id, QString* unitName, QString* abbreviatedUnitName, QString* categoryName);
    void v1UnitsVariableGet(QString* accessToken, QString* unitName, QString* abbreviatedUnitName, QString* categoryName, QString* variable);
