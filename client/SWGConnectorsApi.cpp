...
void
SWGConnectorsApi::v1ConnectJsGet(QString* accessToken) {
    QString fullPath;
    ...
    connect(worker,
            ...
            this,
            &SWGConnectorsApi::v1ConnectJsGetCallback);

    worker->execute(&input);
}

void
SWGConnectorsApi::v1ConnectJsGetCallback(HttpRequestWorker * worker) {
    QString msg;
    ...
    emit v1ConnectJsGetSignal();
}
void
SWGConnectorsApi::v1ConnectMobileGet(QString* accessToken) {
    QString fullPath;
...
void
SWGConnectorsApi::v1ConnectorsConnectorConnectGet(QString* connector, QString* accessToken) {
    QString fullPath;
...
void
SWGConnectorsApi::v1ConnectorsConnectorConnectInstructionsGet(QString* connector, QString* parameters, QString* url, bool usePopup, QString* accessToken) {
    QString fullPath;
...
void
SWGConnectorsApi::v1ConnectorsConnectorConnectParameterGet(QString* connector, QString* displayName, QString* key, QString* placeholder, QString* type, bool usePopup, QString* accessToken, QString* defaultValue) {
    QString fullPath;
...
void
SWGConnectorsApi::v1ConnectorsConnectorInfoGet(QString* connector, QString* accessToken) {
    QString fullPath;
...
void
SWGConnectorsApi::v1ConnectorsConnectorUpdateGet(QString* connector, QString* accessToken) {
    QString fullPath;
