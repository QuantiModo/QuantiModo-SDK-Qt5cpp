...
onsetDelay = NULL;
experimentStartTime = new QString("");
experimentEndTime = new QString("");
}
...
if(experimentStartTime != NULL) {
        delete experimentStartTime;
    }
if(experimentEndTime != NULL) {
        delete experimentEndTime;
    }
}
...
setValue(&maximumAllowedValue, pJson["maximumAllowedValue"], "float", "");
setValue(&minimumAllowedValue, pJson["minimumAllowedValue"], "float", "");
setValue(&onsetDelay, pJson["onsetDelay"], "qint32", "");
setValue(&experimentStartTime, pJson["experimentStartTime"], "QString", "QString");
setValue(&experimentEndTime, pJson["experimentEndTime"], "QString", "QString");
}
...
obj->insert("maximumAllowedValue", QJsonValue(maximumAllowedValue));
obj->insert("minimumAllowedValue", QJsonValue(minimumAllowedValue));
obj->insert("onsetDelay", QJsonValue(onsetDelay));

    
    toJsonValue(QString("experimentStartTime"), experimentStartTime, obj, QString("QString"));
    
        

    
    toJsonValue(QString("experimentEndTime"), experimentEndTime, obj, QString("QString"));
...
qint32
SWGUserVariables::getVariableId() {
    return variableId;
}
void
SWGUserVariables::setVariableId(qint32 variableId) {
...
QString*
SWGUserVariables::getExperimentStartTime() {
    return experimentStartTime;
}
void
SWGUserVariables::setExperimentStartTime(QString* experimentStartTime) {
    this->experimentStartTime = experimentStartTime;
}

QString*
SWGUserVariables::getExperimentEndTime() {
    return experimentEndTime;
}
void
SWGUserVariables::setExperimentEndTime(QString* experimentEndTime) {
