...
organizationAccessToken = new QString("");
}
...
if(organizationAccessToken != NULL) {
        delete organizationAccessToken;
    }
}
...
setValue(&organizationAccessToken, pJson["organizationAccessToken"], "QString", "QString");
}
...
SWGUserTokenRequest::asJsonObject() {
    ...
    toJsonValue(QString("organizationAccessToken"), organizationAccessToken, obj, QString("QString"));
...
void
SWGUserTokenRequest::setOrganizationAccessToken(QString* organizationAccessToken) {
