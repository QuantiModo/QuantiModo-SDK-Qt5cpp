...
void
SWGPairsApi::v1PairsCsvGet(QString* cause, QString* effect, QString* accessToken, QString* causeSource, QString* causeUnit, QString* delay, QString* duration, QString* effectSource, QString* effectUnit, QString* endTime, QString* startTime, qint32 limit, qint32 offset, qint32 sort) {
    QString fullPath;
    fullPath.append(this->host).append(this->basePath).append("/v1/pairsCsv");
    ...
    connect(worker,
            ...
            this,
            &SWGPairsApi::v1PairsCsvGetCallback);

    worker->execute(&input);
}

void
SWGPairsApi::v1PairsCsvGetCallback(HttpRequestWorker * worker) {
    QString msg;
    ...
    emit v1PairsCsvGetSignal(output);
    
}
void
SWGPairsApi::v1PairsGet(QString* cause, QString* effect, QString* accessToken, QString* causeSource, QString* causeUnit, QString* delay, QString* duration, QString* effectSource, QString* effectUnit, QString* endTime, QString* startTime, qint32 limit, qint32 offset, qint32 sort) {
    QString fullPath;
