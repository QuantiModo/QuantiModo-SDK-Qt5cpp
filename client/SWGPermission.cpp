...
setValue(&minTimestamp, pJson["minTimestamp"], "qint32", "");
setValue(&maxTimestamp, pJson["maxTimestamp"], "qint32", "");
setValue(&minTimeOfDay, pJson["minTimeOfDay"], "qint32", "");
setValue(&maxTimeOfDay, pJson["maxTimeOfDay"], "qint32", "");
...
obj->insert("minTimestamp", QJsonValue(minTimestamp));
obj->insert("maxTimestamp", QJsonValue(maxTimestamp));
obj->insert("minTimeOfDay", QJsonValue(minTimeOfDay));
obj->insert("maxTimeOfDay", QJsonValue(maxTimeOfDay));
...
void
SWGPermission::setMinTimestamp(qint32 minTimestamp) {
...
void
SWGPermission::setMaxTimestamp(qint32 maxTimestamp) {
...
void
SWGPermission::setMinTimeOfDay(qint32 minTimeOfDay) {
...
void
SWGPermission::setMaxTimeOfDay(qint32 maxTimeOfDay) {
